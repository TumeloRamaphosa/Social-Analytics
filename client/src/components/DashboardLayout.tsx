...
import { LayoutDashboard, LogOut, PanelLeft, Search, Globe, Clock, Brain, Zap, Sparkles, Link, Tag, Bot, Cpu, BarChart2, BookOpen, Info, Film, Building2 } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Building2, label: "Client Portals", path: "/clients" },
